...
const loop = () => {
  ...
  renderResets()
  refreshAffordability()
  // Update exchange rate displays in real-time
  if (window.updateBuyRate) window.updateBuyRate()
  if (window.updateSellRate) window.updateSellRate()
